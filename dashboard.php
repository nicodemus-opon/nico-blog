...
<div class="container">
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Super User</h6>
    <p class="card-text">allow the Super_User to change his/her personal details including password but NOT the username.</p>
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Super User</h6>
    <p class="card-text">allow the Super_User to
        Add a new user,
        See a list of all other users,
        Update any user’s details,
        and Delete any user.</p>
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Super User</h6>
    <p class="card-text">allow the user to see the last 6 posted Articles in a descending order by [article_created_date]</p>
...
<div class="container">
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Super User</h6>
    <p class="card-text">allow the Super_User to sign-out.</p>
